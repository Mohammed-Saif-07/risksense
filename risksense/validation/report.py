...
scope, conceptual soundness, data quality, backtesting results, benchmarking
of all four VaR engines, sensitivity analysis, limitations & assumptions,
and the ongoing monitoring plan. Federal Reserve SR 11-7 / OCC 2011-12.
"""
