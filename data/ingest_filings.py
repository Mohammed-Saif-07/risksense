"""Ingest 10-K Item 1A Risk Factors from SEC EDGAR (Month 4 deliverable).
...
Status: stub — ships in Month 4 with the narrative overlay.
"""
...
def ingest() -> None:
    ...
    raise NotImplementedError("EDGAR filings ingestion ships in Month 4.")
